...
typedef struct {
    ...
    volatile uint32_t       timeMs;    /*!< Current time in units of milliseconds */
    volatile NB_Error_t     retVal;    /*!< Return value */

    /*! Hardware management */

    /*!< Active command informations */
    volatile NB_CmdParam_t  cmdParam;  /*!< Command exe param */
    volatile NB_Error_t     cmdRetVal; /*!< Result to return from function */
    volatile NB_Cmd_t       cmd;       /*!< Current active Cmd */
    volatile NB_Cmd_t       cmdSaved;  /*!< Saved active Cmd */
    const char* volatile    cmdRspStr; /*!< Active command response buffer */
    volatile uint32_t       cmdTime;   /*!< Command started time */
    volatile uint32_t       cmdTmout;  /*!< Timeout in units of MS for active command to finish */
    
    char                    imsi[16];  /*!< Device IMSI number */
    char                    imei[16];  /*!< Device IMEI number */
    volatile uint8_t        rssi;      /*!< Signal strength */
    volatile uint8_t        cfun;      /*!< Phone Functionality */
    volatile uint16_t       cme;       /*!< CME Error Code */
    volatile NB_NetStatus_t netStat;   /*!< Network status */
    NB_ConnType_t           connType;  /*!< Network connect type */
    uint8_t                 ipAddr[4]; /*!< Device IP address */
    volatile uint8_t        connStat;  /*!< 1 Connected, 0 Idle */

    
    volatile NB_Datetime_t  datetime;  /*!< Network date time */
