 ...
 * RS485电源控制
 */
#define GPIO_PORT_KZ    GPIOA

#define GPIO_PIN_KZ     GPIO_Pin_12

#define GPIO_CLK_KZ     RCC_AHBPeriph_GPIOA
...
uint8_t RS485Init(void)
{
  ...
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_GPIOA | GPIO_CLK_KZ, ENABLE);
...
uint8_t RS485CheckReceive(void)
{
  ...
  if ((SYSGetTickCount() - s_ulLastRecvCharTick > pdMS_TO_TICKS(RS485_RX_TIMEOUT)) \
