...
#define GPIO_CLK_SDA	RCC_AHBPeriph_GPIOB
#define GPIO_CLK_CLK	RCC_AHBPeriph_GPIOB
#define GPIO_CLK_WP 	RCC_AHBPeriph_GPIOB
...
void FRAM_Init(void)
{
  ...
  RCC_AHBPeriphClockCmd(GPIO_CLK_SDA | GPIO_CLK_CLK | GPIO_CLK_WP, ENABLE);
