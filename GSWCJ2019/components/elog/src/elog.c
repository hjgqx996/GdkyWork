...
void elog_start(void) {
    ...
    /* show version */
    log_i("Elog V%s is initialize success.", ELOG_SW_VERSION);
}
...
/**
 * Set a hook function to Elog assert. It will run when the expression is false.
 *
