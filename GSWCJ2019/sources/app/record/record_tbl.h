...
/* 系统参数 */
#define REC_Size_SysParam         (sizeof(SysParam_t) * 2)
#define REC_Size_NetParam         (sizeof(NetParam_t))
#define REC_Size_TempCollect      (sizeof(TempCollect_t) * 10)

/* 定义各个数据类型存储起始地址 */

/* FM24W256_2 U3=001 */ ////????
#define REC_Addr_SysParam         0x00000000
#define REC_Addr_NetParam         (REC_Addr_SysParam + REC_Size_SysParam)
#define REC_Addr_TempCollect      (REC_Addr_NetParam + REC_Size_NetParam)
