...
typedef enum
{
  ...
  NB_State_WaitStart,
  NB_State_ModInit,
  NB_State_ModInitWait,         //20190509,scf.
  NB_State_NetConfig,
  NB_State_NetConfigWait,       //20190509,scf.
  NB_State_NetAttach,
  NB_State_NetAttachWait,       //20190509,scf.
  
  NB_State_WaitAttach,
  NB_State_WaitAttachIMSI,      //20190509,scf.
  NB_State_WaitAttachGetStatus,
  NB_State_WaitAttachGetRSSI,
  NB_State_WaitAttachGetIP,
  NB_State_WaitAttachGetCSCON,
 ...
 *  发送数据运行状态
 */
typedef enum           //20190513,scf.
{
  NB_SendState_Idle  = 0,
  NB_SendState_GetRSSI,       // 读CSQ
  NB_SendState_GetRSSI_Wait,  // 
  NB_SendState_Start,         // send init
  NB_SendState_Wait,          // send wait
  NB_SendState_fail,          // send fail
  NB_SendState_OK,            // send OK
}NB_SendState_t;
...
// Print
#ifdef DEBUG_ON
  #define NB_Print(tag, ...)  printf(""tag"\r\n", ##__VA_ARGS__)
#else
  #define NB_Print(tag, ...)
#endif
...
NB_State_t nbAppSendRun(void);//20190510,scf.
